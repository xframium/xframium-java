 ...
 */
public class HomeAction extends AbstractDefaultAction implements DeviceAction
{
	...
	public boolean _executeAction( WebDriver webDriver, List<Object> parameterList )
	{
		...
		PerfectoMobile.instance( ( (DeviceWebDriver) webDriver ).getxFID() ).device().home( executionId, deviceName );
		return true;
	}
