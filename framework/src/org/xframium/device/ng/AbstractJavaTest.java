...
public abstract class AbstractJavaTest extends AbstractSeleniumTest
{
    ...
    public void beforeMethod( Method currentMethod, Object[] testArgs )
    {
        ...
        KeyWordTest kwt = new KeyWordTest( currentMethod.getName(), true, null, null, false, null, null, 0, currentMethod.getName() + " from " + currentMethod.getClass().getName(), null, null, null, null, 0 );
        eC.setTest( kwt );
