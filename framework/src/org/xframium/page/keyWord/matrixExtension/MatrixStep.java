...
public class MatrixStep
{
    ...
    {
        KeyWordStep kStep = KeyWordStepFactory.instance().createStep( name, pageName, active, type, linkId, timed, failureMode, inverse, os, browser, poi, threshold, "", wait, context, validationDetail, device, vType, tagNames, startAt, false, deviceTags, siteName, configProperties, version, appContext, null, false, null, null, false );
    ...
    private void parseStep()
    {
        for ( int i=0; i<stepArray.length; i++ )
        {
            switch ( i+1 )
            {
                ...
                case 25:
                    appContext = parseString( stepArray[ i ], null, false );
                    break;
            }
        }
    }
