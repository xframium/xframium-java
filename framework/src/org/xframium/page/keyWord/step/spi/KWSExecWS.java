...
public class KWSExecWS extends AbstractKeyWordStep
{
  ...
  public boolean _executeStep( Page pageObject, WebDriver webDriver, Map<String, Object> contextMap, Map<String, PageData> dataMap, Map<String, Page> pageMap, SuiteContainer sC, ExecutionContextTest executionContext )
  {
    ...
    try
    {
      ...
      if ((getContext() != null) && (data.size() > 0))
      {
  ...
  private WebServiceClientUtil.CallDetails loadCallDetails( List<KeyWordParameter> paramList, Map<String, Object> contextMap, Map<String, PageData> dataMap, ExecutionContextTest executionContext )
  {
    ...
    while (params.hasNext())
    {
      ...
      if ((param.getUsage() != null) && (!INPUT.equalsIgnoreCase(param.getUsage())))
      {
        continue;
      }
    ...
    rtn.setValid(((rtn.getUrl() != null) && (rtn.getMethod() != null) && (rtn.getType() != null) && ((!rtn.getMethod().equalsIgnoreCase(HTTP_POST)) || ((rtn.getMethod().equalsIgnoreCase(HTTP_POST)) && (rtn.getPayload() != null) && (rtn.getMediaType() != null)))));
  ...
  private void throwCallDetailsException( WebServiceClientUtil.CallDetails callDetails )
  {
    ...
    else if ((callDetails.getMethod().equalsIgnoreCase(HTTP_POST)) && ((callDetails.getPayload() == null) || (callDetails.getMediaType() == null)))
  ...
  private WebServiceClientUtil.ResponceDetails loadResponceDetails( List<KeyWordParameter> paramList )
  {
    ...
    while (params.hasNext())
    {
      ...
      if ((param.getUsage() == null) || (!OUTPUT.equalsIgnoreCase(param.getUsage())))
      {
        continue;
      }
