 ...
 *******************************************************************************/
package com.xframium.page.keyWord.provider;
...
import com.xframium.page.keyWord.KeyWordToken;
import com.xframium.page.keyWord.KeyWordParameter.ParameterType;
import com.xframium.page.keyWord.KeyWordStep.StepFailure;
import com.xframium.page.keyWord.KeyWordStep.ValidationType;
import com.xframium.page.keyWord.KeyWordToken.TokenType;
import com.xframium.page.keyWord.provider.xsd.Import;
import com.xframium.page.keyWord.provider.xsd.Model;
import com.xframium.page.keyWord.provider.xsd.ObjectFactory;
import com.xframium.page.keyWord.provider.xsd.Parameter;
import com.xframium.page.keyWord.provider.xsd.RegistryRoot;
import com.xframium.page.keyWord.provider.xsd.Step;
import com.xframium.page.keyWord.provider.xsd.Test;
import com.xframium.page.keyWord.provider.xsd.Token;
import com.xframium.page.keyWord.step.KeyWordStepFactory;
...
public class XMLKeyWordProvider implements KeyWordProvider
{
	...
	{
	    for ( com.xframium.page.keyWord.provider.xsd.Page page : model.getPage() )
	    {
	        try
	        {
